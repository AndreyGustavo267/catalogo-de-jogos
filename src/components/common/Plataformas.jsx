...
export default function Plataformas({ plataformas, onClick }) {
  const renderIcon = (plat) => {
    ...
    } else if (lower.includes("ps") || lower.includes("playstation")) {
      iconContent = <PlaystationIcon />;
    } else if (lower.includes("xbox")) {
      iconContent = <XboxIcon />;
