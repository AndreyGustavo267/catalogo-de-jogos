...
export default function AjudaPage() {
  const items = [
    {
      ...
      children: <p style={{ color: "#c7d5e0" }}>Você precisa criar uma conta e estar logado. Depois, basta clicar no botão "Avaliar" na lista de jogos.</p>,
    },
    {
      key: '2',
      label: <strong style={{ color: "#fff" }}>O IGDb é gratuito?</strong>,
      children: <p style={{ color: "#c7d5e0" }}>Sim! Este é um projeto de código aberto e totalmente gratuito para a comunidade.</p>,
    },
  ];
  ...
  return (
    ...
    >
      <Title id="titulo-ajuda" level={1} style={{ color: "#fff" }}>
        Central de Ajuda
      </Title>
